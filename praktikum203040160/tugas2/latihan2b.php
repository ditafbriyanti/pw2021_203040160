...
<body>
<?php
    $jawabanIsset = "Isset adalah = Berfungsi untuk memeriksa apakah suatu variabel sudah diatur atau belum. Fungsi isset juga mengembalikam false jika variabel pengujian berisi nilai NULL. <br></br>";
